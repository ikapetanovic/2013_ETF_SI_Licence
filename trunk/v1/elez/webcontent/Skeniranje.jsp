...
if(request.getParameter("skeniraj")!=null){
	RuntimeExec skeniranje = new RuntimeExec();
	skeniranje.Skeniraj(request.getParameter("a"),request.getParameter("b"),request.getParameter("c"),Integer.parseInt(request.getParameter("pocetna")),Integer.parseInt(request.getParameter("krajnja")),request.getParameter("user"),request.getParameter("pass"),Integer.parseInt(request.getParameter("lista")));
}
%>

<% if(request.getParameter("sebe")!=null){
	RuntimeExec scan = new RuntimeExec();
	scan.SkenirajMene(Integer.parseInt(request.getParameter("lista")));
}%>
		<CENTER>
...
<FORM action="Skeniranje.jsp" method=GET ><center>
...
FilijalaDAO f1 = new FilijalaDAO();
 ...
 %>
			...
			<form action="Skeniranje.jsp" method=GET>
			...
			<br>
			<INPUT type = "submit" name="skeniraj" id="skeniraj" value="Skeniraj mrežu">	
</td></tr>
			</table>
</center>
...
<TR>
				...
				<A href = "Skeniranje.jsp" id = "linkSfotver" CLASS="navigacija">Detekcija racunara</A><BR>
					</TD></tr>
